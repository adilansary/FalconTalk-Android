...
public class ActiavityMain {
	public static AppiumDriver driverActivityMain;
	...
	public static void AndroidLaunchApp() throws MalformedURLException {
		...
		driverActivityMain = new AppiumDriver(new URL("http://127.0.0.1:4723/"),cap);
		AppDriver.setDriver(driverActivityMain);
		
	}

	public static String deviceName() {
		String devicName = driverActivityMain.getCapabilities().getCapability("deviceModel").toString();
		return devicName;
	}
//	public static void hideKeyboard(){
//		driverActivityMain.hideKeyboard();
//	}
