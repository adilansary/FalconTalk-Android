...
public class Utils {
    ...
    public static void longPress(WebElement element) {
    	new TouchAction((PerformsTouchActions) AppDriver.getDriver()).longPress(LongPressOptions.longPressOptions().withElement(ElementOption.element(element))).perform();
    }
